...
{
    public class ApofasiCorrectAnService : IApofasiCorrectAnService, IDisposable
    {
        private readonly IrisDBEntities entities;

        public ApofasiCorrectAnService(IrisDBEntities entities)
        {
            this.entities = entities;
        }

        public IEnumerable<ApofasiCorrectAnaplirotesGridViewModel> Read(int schoolyearId = 0, int adminId = 0)
        {
            List<ApofasiCorrectAnaplirotesGridViewModel> data = new List<ApofasiCorrectAnaplirotesGridViewModel>();

            if (schoolyearId > 0 && adminId > 0)
            {
                data = (from d in entities.ΑΠΟΦΑΣΕΙΣ_ΔΙΟΡΘΩΤΙΚΕΣ_ΑΝ
                        ...
                        select new ApofasiCorrectAnaplirotesGridViewModel
                        {
        ...
        public void Create(ApofasiCorrectAnaplirotesGridViewModel data)
        {
            ΑΠΟΦΑΣΕΙΣ_ΔΙΟΡΘΩΤΙΚΕΣ_ΑΝ entity = new ΑΠΟΦΑΣΕΙΣ_ΔΙΟΡΘΩΤΙΚΕΣ_ΑΝ();

            entity.ΑΠΟΦΑΣΗ_ΕΙΔΟΣ = "ΔΙΟΡΘΩΤΙΚΗ-ΑΝ";
            ...
            entities.ΑΠΟΦΑΣΕΙΣ_ΔΙΟΡΘΩΤΙΚΕΣ_ΑΝ.Add(entity);
            entities.SaveChanges();

            data.ΑΠΟΦΑΣΗ_ΚΩΔ = entity.ΑΠΟΦΑΣΗ_ΚΩΔ;
        }

        public void Update(ApofasiCorrectAnaplirotesGridViewModel data)
        {
            ΑΠΟΦΑΣΕΙΣ_ΔΙΟΡΘΩΤΙΚΕΣ_ΑΝ entity = entities.ΑΠΟΦΑΣΕΙΣ_ΔΙΟΡΘΩΤΙΚΕΣ_ΑΝ.Find(data.ΑΠΟΦΑΣΗ_ΚΩΔ);
        ...
        public void Destroy(ApofasiCorrectAnaplirotesGridViewModel data)
        {
            ΑΠΟΦΑΣΕΙΣ_ΔΙΟΡΘΩΤΙΚΕΣ_ΑΝ entity = entities.ΑΠΟΦΑΣΕΙΣ_ΔΙΟΡΘΩΤΙΚΕΣ_ΑΝ.Find(data.ΑΠΟΦΑΣΗ_ΚΩΔ);
            ...
            if (entity != null)
            {
                ...
                entities.ΑΠΟΦΑΣΕΙΣ_ΔΙΟΡΘΩΤΙΚΕΣ_ΑΝ.Remove(entity);
                entities.SaveChanges();
            }
        }

        public ApofasiCorrectAnaplirotesGridViewModel Refresh(int entityId)
        {
            return entities.ΑΠΟΦΑΣΕΙΣ_ΔΙΟΡΘΩΤΙΚΕΣ_ΑΝ.Select(d => new ApofasiCorrectAnaplirotesGridViewModel
            {
                ΑΠΟΦΑΣΗ_ΕΙΔΟΣ = d.ΑΠΟΦΑΣΗ_ΕΙΔΟΣ,
                ΑΠΟΦΑΣΗ_ΚΩΔ = d.ΑΠΟΦΑΣΗ_ΚΩΔ,
                ΔΙΑΧΕΙΡΙΣΤΗΣ = d.ΔΙΑΧΕΙΡΙΣΤΗΣ,
        ...
        public ApofasiCorrectAnaplirotesViewModel GetRecord(int apofasiId)
        {
            var data = (from d in entities.ΑΠΟΦΑΣΕΙΣ_ΔΙΟΡΘΩΤΙΚΕΣ_ΑΝ
        ...
        public void UpdateRecord(ApofasiCorrectAnaplirotesViewModel data, int apofasiId, int departement)
        {
            ΑΠΟΦΑΣΕΙΣ_ΔΙΟΡΘΩΤΙΚΕΣ_ΑΝ entity = entities.ΑΠΟΦΑΣΕΙΣ_ΔΙΟΡΘΩΤΙΚΕΣ_ΑΝ.Find(apofasiId);
