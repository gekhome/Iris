...
{
    public class ApofasiCancelService : IApofasiCancelService, IDisposable
    {
        private readonly IrisDBEntities entities;

        public ApofasiCancelService(IrisDBEntities entities)
        {
            this.entities = entities;
        }

        public IEnumerable<ApofasiCancelGridViewModel> Read(int schoolyearId = 0, int adminId = 0)
        {
            List<ApofasiCancelGridViewModel> data = new List<ApofasiCancelGridViewModel>();

            if (schoolyearId > 0 && adminId > 0)
            {
                data = (from d in entities.ΑΠΟΦΑΣΕΙΣ_ΑΚΥΡΩΤΙΚΕΣ
                        ...
                        select new ApofasiCancelGridViewModel
                        {
        ...
        public IEnumerable<ApofasiCancelGridViewModel> Read2(int schoolyearId = 0, int adminId = 0)
        {
            List<ApofasiCancelGridViewModel> data = new List<ApofasiCancelGridViewModel>();
        ...
        public void Create(ApofasiCancelGridViewModel data)
        {
            ΑΠΟΦΑΣΕΙΣ_ΑΚΥΡΩΤΙΚΕΣ entity = new ΑΠΟΦΑΣΕΙΣ_ΑΚΥΡΩΤΙΚΕΣ();
            ...
            entities.ΑΠΟΦΑΣΕΙΣ_ΑΚΥΡΩΤΙΚΕΣ.Add(entity);
            entities.SaveChanges();

            data.ΑΠΟΦΑΣΗ_ΚΩΔ = entity.ΑΠΟΦΑΣΗ_ΚΩΔ;
        }

        public void Update(ApofasiCancelGridViewModel data)
        {
            ΑΠΟΦΑΣΕΙΣ_ΑΚΥΡΩΤΙΚΕΣ entity = entities.ΑΠΟΦΑΣΕΙΣ_ΑΚΥΡΩΤΙΚΕΣ.Find(data.ΑΠΟΦΑΣΗ_ΚΩΔ);
        ...
        public void Destroy(ApofasiCancelGridViewModel data)
        {
            ΑΠΟΦΑΣΕΙΣ_ΑΚΥΡΩΤΙΚΕΣ entity = entities.ΑΠΟΦΑΣΕΙΣ_ΑΚΥΡΩΤΙΚΕΣ.Find(data.ΑΠΟΦΑΣΗ_ΚΩΔ);
            ...
            if (entity != null)
            {
                ...
                entities.ΑΠΟΦΑΣΕΙΣ_ΑΚΥΡΩΤΙΚΕΣ.Remove(entity);
                entities.SaveChanges();
            }
        }

        public ApofasiCancelGridViewModel Refresh(int entityId)
        {
            return entities.ΑΠΟΦΑΣΕΙΣ_ΑΚΥΡΩΤΙΚΕΣ.Select(d => new ApofasiCancelGridViewModel
            {
                ΑΠΟΦΑΣΗ_ΕΙΔΟΣ = d.ΑΠΟΦΑΣΗ_ΕΙΔΟΣ,
                ΑΠΟΦΑΣΗ_ΚΩΔ = d.ΑΠΟΦΑΣΗ_ΚΩΔ,
                ΔΙΑΧΕΙΡΙΣΤΗΣ = d.ΔΙΑΧΕΙΡΙΣΤΗΣ,
        ...
        public ApofasiCancelViewModel GetRecord(int apofasiId)
        {
            var data = (from d in entities.ΑΠΟΦΑΣΕΙΣ_ΑΚΥΡΩΤΙΚΕΣ
        ...
        public void UpdateRecord(ApofasiCancelViewModel data, int apofasiId, int departement)
        {
            ΑΠΟΦΑΣΕΙΣ_ΑΚΥΡΩΤΙΚΕΣ entity = entities.ΑΠΟΦΑΣΕΙΣ_ΑΚΥΡΩΤΙΚΕΣ.Find(apofasiId);
