...
{
    public class ApofasiModifyService : IApofasiModifyService, IDisposable
    {
        private readonly IrisDBEntities entities;

        public ApofasiModifyService(IrisDBEntities entities)
        {
            this.entities = entities;
        }

        public IEnumerable<ApofasiModifyGridViewModel> Read(int schoolyearId = 0, int adminId = 0)
        {
            List<ApofasiModifyGridViewModel> data = new List<ApofasiModifyGridViewModel>();

            if (schoolyearId > 0 && adminId > 0)
            {
                data = (from d in entities.ΑΠΟΦΑΣΕΙΣ_ΤΡΟΠΟΠΟΙΗΤΙΚΕΣ
                        ...
                        select new ApofasiModifyGridViewModel
                        {
        ...
        public IEnumerable<ApofasiModifyGridViewModel> Read2(int schoolyearId = 0, int adminId = 0)
        {
            List<ApofasiModifyGridViewModel> data = new List<ApofasiModifyGridViewModel>();
        ...
        public void Create(ApofasiModifyGridViewModel data)
        {
            ΑΠΟΦΑΣΕΙΣ_ΤΡΟΠΟΠΟΙΗΤΙΚΕΣ entity = new ΑΠΟΦΑΣΕΙΣ_ΤΡΟΠΟΠΟΙΗΤΙΚΕΣ();

            entity.ΑΠΟΦΑΣΗ_ΕΙΔΟΣ = "ΤΡΟΠΟΠΟΙΗΤΙΚΗ";
            ...
            entities.ΑΠΟΦΑΣΕΙΣ_ΤΡΟΠΟΠΟΙΗΤΙΚΕΣ.Add(entity);
            entities.SaveChanges();

            data.ΑΠΟΦΑΣΗ_ΚΩΔ = entity.ΑΠΟΦΑΣΗ_ΚΩΔ;
        }

        public void Update(ApofasiModifyGridViewModel data)
        {
            ΑΠΟΦΑΣΕΙΣ_ΤΡΟΠΟΠΟΙΗΤΙΚΕΣ entity = entities.ΑΠΟΦΑΣΕΙΣ_ΤΡΟΠΟΠΟΙΗΤΙΚΕΣ.Find(data.ΑΠΟΦΑΣΗ_ΚΩΔ);
        ...
        public void Destroy(ApofasiModifyGridViewModel data)
        {
            ΑΠΟΦΑΣΕΙΣ_ΤΡΟΠΟΠΟΙΗΤΙΚΕΣ entity = entities.ΑΠΟΦΑΣΕΙΣ_ΤΡΟΠΟΠΟΙΗΤΙΚΕΣ.Find(data.ΑΠΟΦΑΣΗ_ΚΩΔ);
            ...
            if (entity != null)
            {
                ...
                entities.ΑΠΟΦΑΣΕΙΣ_ΤΡΟΠΟΠΟΙΗΤΙΚΕΣ.Remove(entity);
                entities.SaveChanges();
            }
        }

        public ApofasiModifyGridViewModel Refresh(int entityId)
        {
            return entities.ΑΠΟΦΑΣΕΙΣ_ΤΡΟΠΟΠΟΙΗΤΙΚΕΣ.Select(d => new ApofasiModifyGridViewModel
            {
                ΑΠΟΦΑΣΗ_ΕΙΔΟΣ = d.ΑΠΟΦΑΣΗ_ΕΙΔΟΣ,
                ΑΠΟΦΑΣΗ_ΚΩΔ = d.ΑΠΟΦΑΣΗ_ΚΩΔ,
                ΔΙΑΧΕΙΡΙΣΤΗΣ = d.ΔΙΑΧΕΙΡΙΣΤΗΣ,
        ...
        public ApofasiModifyViewModel GetRecord(int apofasiId)
        {
            var data = (from d in entities.ΑΠΟΦΑΣΕΙΣ_ΤΡΟΠΟΠΟΙΗΤΙΚΕΣ
        ...
        public void UpdateRecord(ApofasiModifyViewModel data, int apofasiId, int departement)
        {
            ΑΠΟΦΑΣΕΙΣ_ΤΡΟΠΟΠΟΙΗΤΙΚΕΣ entity = entities.ΑΠΟΦΑΣΕΙΣ_ΤΡΟΠΟΠΟΙΗΤΙΚΕΣ.Find(apofasiId);
