...
namespace Iris.Controllers.DataControllers
{
    ...
    public class AdminController : Controller
    {
        ...
        public AdminController(IrisDBEntities entities, IAnathesiInitialService anathesiInitialService,
            ...
            IAnathesiModifyAnAKService anathesiModifyAnAKService, IRegAnathesiProslipsiService regAnathesiProslipsiService,
        ...
        public List<SchoolsGridViewModel> vmSchoolsFromDB()
        {
        ...
        public ActionResult AnatheseisInitial()
        {
            bool val1 = (System.Web.HttpContext.Current.User != null) && System.Web.HttpContext.Current.User.Identity.IsAuthenticated;
            if (!val1)
            {
        ...
        public ActionResult AnatheseisDirect()
        {
            bool val1 = (System.Web.HttpContext.Current.User != null) && System.Web.HttpContext.Current.User.Identity.IsAuthenticated;
            if (!val1)
            {
        ...
        public ActionResult AnatheseisSupplement()
        {
            bool val1 = (System.Web.HttpContext.Current.User != null) && System.Web.HttpContext.Current.User.Identity.IsAuthenticated;
            if (!val1)
            {
        ...
        public ActionResult AnatheseisSupplementAK()
        {
            bool val1 = (System.Web.HttpContext.Current.User != null) && System.Web.HttpContext.Current.User.Identity.IsAuthenticated;
            if (!val1)
            {
        ...
        public ActionResult AnatheseisCancel()
        {
            bool val1 = (System.Web.HttpContext.Current.User != null) && System.Web.HttpContext.Current.User.Identity.IsAuthenticated;
            if (!val1)
            {
        ...
        public ActionResult AnatheseisRevoke()
        {
            bool val1 = (System.Web.HttpContext.Current.User != null) && System.Web.HttpContext.Current.User.Identity.IsAuthenticated;
            if (!val1)
            {
        ...
        public ActionResult AnatheseisModify()
        {
            bool val1 = (System.Web.HttpContext.Current.User != null) && System.Web.HttpContext.Current.User.Identity.IsAuthenticated;
            if (!val1)
            {
        ...
        public ActionResult AnatheseisModifyAK()
        {
            bool val1 = (System.Web.HttpContext.Current.User != null) && System.Web.HttpContext.Current.User.Identity.IsAuthenticated;
            if (!val1)
            {
        ...
        public ActionResult AnatheseisInitialAnaplirotes()
        {
            bool val1 = (System.Web.HttpContext.Current.User != null) && System.Web.HttpContext.Current.User.Identity.IsAuthenticated;
            if (!val1)
            {
        ...
        public ActionResult AnathesiInitialAN_Read([DataSourceRequest] DataSourceRequest request, int schoolyearId = 0, int schoolId = 0)
        {
        ...
        [AcceptVerbs(HttpVerbs.Post)]
        public ActionResult AnathesiInitialAN_Create([DataSourceRequest] DataSourceRequest request, AnathesiInitialAnaplirotesViewModel data, int schoolyearId = 0, int schoolId = 0)
        {
        ...
        [AcceptVerbs(HttpVerbs.Post)]
        public ActionResult AnathesiInitialAN_Update([DataSourceRequest] DataSourceRequest request, AnathesiInitialAnaplirotesViewModel data, int schoolyearId = 0, int schoolId = 0)
        {
            var newdata = new AnathesiInitialAnaplirotesViewModel();
        ...
        public ActionResult AnatheseisSupplementAnaplirotes()
        {
            bool val1 = (System.Web.HttpContext.Current.User != null) && System.Web.HttpContext.Current.User.Identity.IsAuthenticated;
            if (!val1)
            {
        ...
        public ActionResult AnathesiSupplementAN_Read([DataSourceRequest] DataSourceRequest request, int schoolyearId = 0, int schoolId = 0)
        {
        ...
        [AcceptVerbs(HttpVerbs.Post)]
        public ActionResult AnathesiSupplementAN_Create([DataSourceRequest] DataSourceRequest request, AnathesiSupplementAnaplirotesViewModel data, int schoolyearId = 0, int schoolId = 0)
        {
        ...
        [AcceptVerbs(HttpVerbs.Post)]
        public ActionResult AnathesiSupplementAN_Update([DataSourceRequest] DataSourceRequest request, AnathesiSupplementAnaplirotesViewModel data, int schoolyearId = 0, int schoolId = 0)
        {
            var newdata = new AnathesiSupplementAnaplirotesViewModel();
        ...
        public ActionResult AnatheseisCancelAnaplirotes()
        {
            bool val1 = (System.Web.HttpContext.Current.User != null) && System.Web.HttpContext.Current.User.Identity.IsAuthenticated;
            if (!val1)
            {
        ...
        public ActionResult AnathesiCancelAN_Read([DataSourceRequest] DataSourceRequest request, int schoolyearId = 0, int schoolId = 0)
        {
        ...
        [AcceptVerbs(HttpVerbs.Post)]
        public ActionResult AnathesiCancelAN_Create([DataSourceRequest] DataSourceRequest request, AnathesiCancelAnaplirotesViewModel data, int schoolyearId = 0, int schoolId = 0)
        {
        ...
        [AcceptVerbs(HttpVerbs.Post)]
        public ActionResult AnathesiCancelAN_Update([DataSourceRequest] DataSourceRequest request, AnathesiCancelAnaplirotesViewModel data, int schoolyearId = 0, int schoolId = 0)
        {
            var newdata = new AnathesiCancelAnaplirotesViewModel();
        ...
        #region ΑΝΑΘΕΣΕΙΣ ΑΝΑΚΛΗΣΗΣ ΑΝΑΠΛΗΡΩΤΕΣ

        #region GRID CRUD FUNCTIONS

        public ActionResult AnatheseisRevokeAnaplirotes()
        {
            bool val1 = (System.Web.HttpContext.Current.User != null) && System.Web.HttpContext.Current.User.Identity.IsAuthenticated;
            if (!val1)
            {
        ...
        public ActionResult AnathesiRevokeAN_Read([DataSourceRequest] DataSourceRequest request, int schoolyearId = 0, int schoolId = 0)
        {
            var data = anathesiRevokeAnService.Read(schoolyearId, schoolId);

            return Json(data.ToDataSourceResult(request), JsonRequestBehavior.AllowGet);
        }

        [AcceptVerbs(HttpVerbs.Post)]
        public ActionResult AnathesiRevokeAN_Create([DataSourceRequest] DataSourceRequest request, AnathesiRevokeAnaplirotesViewModel data, int schoolyearId = 0, int schoolId = 0)
        {
            ...
            if (schoolyearId > 0 && schoolId > 0)
            {
                ...
                if (!Kerberos.CanCreateRevokeAnaplirotes(data.ΑΦΜ, schoolId, schoolyearId))
                {
                    ModelState.AddModelError("", "Υπάρχει ήδη ανάκληση ανάθεσης για τον εκπαιδευτικό γι' αυτό το σχολείο και σχολικό έτος. Η ενημέρωση ακυρώθηκε.");
                }
                if (data != null && ModelState.IsValid)
                {
                    anathesiRevokeAnService.Create(data, schoolyearId, schoolId);
        ...
        [AcceptVerbs(HttpVerbs.Post)]
        public ActionResult AnathesiRevokeAN_Update([DataSourceRequest] DataSourceRequest request, AnathesiRevokeAnaplirotesViewModel data, int schoolyearId = 0, int schoolId = 0)
        {
            var newdata = new AnathesiRevokeAnaplirotesViewModel();
            ...
            if (schoolyearId > 0 && schoolId > 0)
            {
                ...
                if (!Kerberos.CanEditDeleteRevokeAnaplirotes(data))
                {
                    ModelState.AddModelError("", "Η ανάθεση αυτή έχει εκδοθεί σε Απόφαση. Η ενημέρωση ακυρώθηκε.");
                }
                if (data != null && ModelState.IsValid)
                {
                    anathesiRevokeAnService.Update(data, schoolyearId, schoolId);
                    newdata = anathesiRevokeAnService.Refresh(data.ΑΝΑΘΕΣΗ_ΚΩΔ);
                }
            }
            else
        ...
        [AcceptVerbs(HttpVerbs.Post)]
        public ActionResult AnathesiRevokeAN_Destroy([DataSourceRequest] DataSourceRequest request, AnathesiRevokeAnaplirotesViewModel data)
        {
            if (data != null)
            {
        ...
        #endregion ΑΝΑΘΕΣΕΙΣ ΑΝΑΚΛΗΣΗΣ ΑΝΑΠΛΗΡΩΤΕΣ
        ...
        public ActionResult AnatheseisModifyAnaplirotes()
        {
            bool val1 = (System.Web.HttpContext.Current.User != null) && System.Web.HttpContext.Current.User.Identity.IsAuthenticated;
            if (!val1)
            {
        ...
        public ActionResult AnathesiModifyAN_Read([DataSourceRequest] DataSourceRequest request, int schoolyearId = 0, int schoolId = 0)
        {
        ...
        [AcceptVerbs(HttpVerbs.Post)]
        public ActionResult AnathesiModifyAN_Create([DataSourceRequest] DataSourceRequest request, AnathesiModifyAnaplirotesViewModel data, int schoolyearId = 0, int schoolId = 0)
        {
        ...
        [AcceptVerbs(HttpVerbs.Post)]
        public ActionResult AnathesiModifyAN_Update([DataSourceRequest] DataSourceRequest request, AnathesiModifyAnaplirotesViewModel data, int schoolyearId = 0, int schoolId = 0)
        {
            var newdata = new AnathesiModifyAnaplirotesViewModel();
        ...
        public ActionResult AnatheseisModifyAnaplirotesAK()
        {
            bool val1 = (System.Web.HttpContext.Current.User != null) && System.Web.HttpContext.Current.User.Identity.IsAuthenticated;
            if (!val1)
            {
        ...
        public ActionResult AnathesiModifyANAK_Read([DataSourceRequest] DataSourceRequest request, int schoolyearId = 0, int schoolId = 0)
        {
        ...
        [AcceptVerbs(HttpVerbs.Post)]
        public ActionResult AnathesiModifyANAK_Create([DataSourceRequest] DataSourceRequest request, AnathesiModifyAnaplirotesAKViewModel data, int schoolyearId = 0, int schoolId = 0)
        {
        ...
        [AcceptVerbs(HttpVerbs.Post)]
        public ActionResult AnathesiModifyANAK_Update([DataSourceRequest] DataSourceRequest request, AnathesiModifyAnaplirotesAKViewModel data, int schoolyearId = 0, int schoolId = 0)
        {
            var newdata = new AnathesiModifyAnaplirotesAKViewModel();
        ...
        public ActionResult TransferAgentAnapl(int sourceAnathesiId, string ApofasiType, int targetAnathesiType)
        {
            string msg = "Η μετακίνηση της ανάθεσης δεν είναι έγκυρη και ακυρώθηκε.";
            bool result = false;

            bool rule1 = ApofasiType == "ΑΚΥΡΩΤΙΚΗ-ΑΝ" && (targetAnathesiType == 2 || targetAnathesiType == 7 || targetAnathesiType == 8);
            bool rule2 = ApofasiType == "ΑΝΑΚΛΗΣΗ-ΑΝ" && (targetAnathesiType == 1 || targetAnathesiType == 7 || targetAnathesiType == 8);
            bool rule3 = ApofasiType == "ΑΠΕΥΘΕΙΑΣ-ΑΝ" && (targetAnathesiType == 4 || targetAnathesiType == 5 || targetAnathesiType == 6);
            bool rule4 = ApofasiType == "ΑΡΧΙΚΗ-ΑΝ" && (targetAnathesiType == 3 || targetAnathesiType == 5 || targetAnathesiType == 6);
            bool rule5 = ApofasiType == "ΣΥΜΠΛΗΡΩΜΑΤΙΚΗ-ΑΝ" && (targetAnathesiType == 3 || targetAnathesiType == 4 || targetAnathesiType == 6);
            bool rule6 = ApofasiType == "ΣΥΜΠΛΗΡΩΜΑΤΙΚΗ-ΑΝ-ΑΚ" && (targetAnathesiType == 3 || targetAnathesiType == 4 || targetAnathesiType == 5);
            bool rule7 = ApofasiType == "ΤΡΟΠΟΠΟΙΗΤΙΚΗ-ΑΝ" && (targetAnathesiType == 1 || targetAnathesiType == 2 || targetAnathesiType == 8);
            bool rule8 = ApofasiType == "ΤΡΟΠΟΠΟΙΗΤΙΚΗ-ΑΝ-ΑΚ" && (targetAnathesiType == 1 || targetAnathesiType == 2 || targetAnathesiType == 7);

            if (ApofasiType == "ΑΚΥΡΩΤΙΚΗ-ΑΝ" && rule1)
            {
                result = MoveAnathesiCancelAN(sourceAnathesiId, targetAnathesiType);
                if (result)
                {
                    DeleteAnathesiCancelAN(sourceAnathesiId);
                    msg = "Η μετακίνηση της ανάθεσης ολοκληρώθηκε.";
                }
            }
            else if (ApofasiType == "ΑΝΑΚΛΗΣΗ-ΑΝ" && rule2)
            {
                result = MoveAnathesiRevokeAN(sourceAnathesiId, targetAnathesiType);
                if (result)
                {
                    DeleteAnathesiRevokeAN(sourceAnathesiId);
                    msg = "Η μετακίνηση της ανάθεσης ολοκληρώθηκε.";
                }
            }
            else if (ApofasiType == "ΑΡΧΙΚΗ-ΑΝ" && rule4)
            {
                result = MoveAnathesiInitialAN(sourceAnathesiId, targetAnathesiType);
                if (result)
                {
                    DeleteAnathesiInitialAN(sourceAnathesiId);
                    msg = "Η μετακίνηση της ανάθεσης ολοκληρώθηκε.";
                }
            }
            else if (ApofasiType == "ΣΥΜΠΛΗΡΩΜΑΤΙΚΗ-ΑΝ" && rule5)
            {
                result = MoveAnathesiSupplementAN(sourceAnathesiId, targetAnathesiType);
                if (result) 
                { 
                    DeleteAnathesiSupplementAN(sourceAnathesiId);
                    msg = "Η μετακίνηση της ανάθεσης ολοκληρώθηκε.";
                }
            }
            else if (ApofasiType == "ΤΡΟΠΟΠΟΙΗΤΙΚΗ-ΑΝ" && rule7)
            {
                result = MoveAnathesiModifyAN(sourceAnathesiId, targetAnathesiType);
                if (result)
                {
                    DeleteAnathesiModifyAN(sourceAnathesiId);
                    msg = "Η μετακίνηση της ανάθεσης ολοκληρώθηκε.";
                }
            }
            else if (ApofasiType == "ΤΡΟΠΟΠΟΙΗΤΙΚΗ-ΑΝ-ΑΚ" && rule8)
            {
                result = MoveAnathesiModifyANAK(sourceAnathesiId, targetAnathesiType);
                if (result)
                {
                    DeleteAnathesiModifyANAK(sourceAnathesiId);
                    msg = "Η μετακίνηση της ανάθεσης ολοκληρώθηκε.";
                }
            }
            else
            {
                msg = "Αυτό το είδος μεταφοράς δεν επιτρέπεται λόγω ασυμβατότητας των αναθέσεων.";
            }

            return Json(msg, JsonRequestBehavior.AllowGet);
        }

        public bool MoveAnathesiCancelAN(int sourceAnathesiId, int targetAnathesiType)
        {
            var source = (from d in db.ΑΝΑΘΕΣΕΙΣ_ΑΚΥΡΩΤΙΚΕΣ_ΑΝ where d.ΑΝΑΘΕΣΗ_ΚΩΔ == sourceAnathesiId select d).FirstOrDefault();
            if (source == null) return false;
            if (source.ΑΠΟΦΑΣΗ_ΚΩΔ > 0) return false;
            ...
            if (targetAnathesiType == 2)
            {
                ΑΝΑΘΕΣΕΙΣ_ΑΝΑΚΛΗΣΗΣ_ΑΝ entity = new ΑΝΑΘΕΣΕΙΣ_ΑΝΑΚΛΗΣΗΣ_ΑΝ()
                {
                    ...
                    ΣΧΟΛΗ = source.ΣΧΟΛΗ,
                    ΣΥΜΒΑΣΗ = source.ΣΥΜΒΑΣΗ,               
                    ΑΠΟΦΑΣΗ_ΕΙΔΟΣ = "ΑΝΑΚΛΗΣΗ-ΑΝ",
                    ΑΠΟΦΑΣΗ_ΚΩΔ = 0,
                    ΚΛΑΔΟΣ_ΚΩΔ = source.ΚΛΑΔΟΣ_ΚΩΔ,
                    ΩΡΟΜΙΣΘΙΟ_ΚΩΔ = source.ΩΡΟΜΙΣΘΙΟ_ΚΩΔ,
                    ΦΥΛΟ = source.ΦΥΛΟ
                };
                db.ΑΝΑΘΕΣΕΙΣ_ΑΝΑΚΛΗΣΗΣ_ΑΝ.Add(entity);
                db.SaveChanges();
            }
            else if (targetAnathesiType == 7)
            {
                ΑΝΑΘΕΣΕΙΣ_ΤΡΟΠΟΠΟΙΗΤΙΚΕΣ_ΑΝ entity = new ΑΝΑΘΕΣΕΙΣ_ΤΡΟΠΟΠΟΙΗΤΙΚΕΣ_ΑΝ()
                {
                    ΑΦΜ = source.ΑΦΜ,
                    ΕΠΩΝΥΜΟ = source.ΕΠΩΝΥΜΟ,
                    ΟΝΟΜΑ = source.ΟΝΟΜΑ,
                    ...
                    ΣΧΟΛΗ = source.ΣΧΟΛΗ,
                    ΣΥΜΒΑΣΗ = source.ΣΥΜΒΑΣΗ,               
                    ΑΠΟΦΑΣΗ_ΕΙΔΟΣ = "ΤΡΟΠΟΠΟΙΗΤΙΚΗ-ΑΝ",
                    ΑΠΟΦΑΣΗ_ΚΩΔ = 0,
                    ΚΛΑΔΟΣ_ΚΩΔ = source.ΚΛΑΔΟΣ_ΚΩΔ,
                    ΩΡΟΜΙΣΘΙΟ_ΚΩΔ = source.ΩΡΟΜΙΣΘΙΟ_ΚΩΔ,
                    ΦΥΛΟ = source.ΦΥΛΟ
                };
                db.ΑΝΑΘΕΣΕΙΣ_ΤΡΟΠΟΠΟΙΗΤΙΚΕΣ_ΑΝ.Add(entity);
                db.SaveChanges();
            }
            else if (targetAnathesiType == 8)
            {
                ΑΝΑΘΕΣΕΙΣ_ΤΡΟΠΟΠΟΙΗΤΙΚΕΣ_ΑΝ_ΑΚ entity = new ΑΝΑΘΕΣΕΙΣ_ΤΡΟΠΟΠΟΙΗΤΙΚΕΣ_ΑΝ_ΑΚ()
                {
                    ...
                    ΣΧΟΛΗ = source.ΣΧΟΛΗ,
                    ΣΥΜΒΑΣΗ = source.ΣΥΜΒΑΣΗ,            
                    ΑΠΟΦΑΣΗ_ΕΙΔΟΣ = "ΤΡΟΠΟΠΟΙΗΤΙΚΗ-ΑΝ-ΑΚ",
                    ΑΠΟΦΑΣΗ_ΚΩΔ = 0,
                    ΚΛΑΔΟΣ_ΚΩΔ = source.ΚΛΑΔΟΣ_ΚΩΔ,
                    ΩΡΟΜΙΣΘΙΟ_ΚΩΔ = source.ΩΡΟΜΙΣΘΙΟ_ΚΩΔ,
                    ΦΥΛΟ = source.ΦΥΛΟ
                };
                db.ΑΝΑΘΕΣΕΙΣ_ΤΡΟΠΟΠΟΙΗΤΙΚΕΣ_ΑΝ_ΑΚ.Add(entity);
                db.SaveChanges();
            }
            return true;
        }

        public bool DeleteAnathesiCancelAN(int sourceAnathesiId)
        {
            ΑΝΑΘΕΣΕΙΣ_ΑΚΥΡΩΤΙΚΕΣ_ΑΝ entity = db.ΑΝΑΘΕΣΕΙΣ_ΑΚΥΡΩΤΙΚΕΣ_ΑΝ.Find(sourceAnathesiId);
            if (entity != null)
            {
                db.Entry(entity).State = EntityState.Deleted;
                db.ΑΝΑΘΕΣΕΙΣ_ΑΚΥΡΩΤΙΚΕΣ_ΑΝ.Remove(entity);
                db.SaveChanges();
                return true;
            }
            else return false;
        ...
        public bool MoveAnathesiRevokeAN(int sourceAnathesiId, int targetAnathesiType)
        {
            var source = (from d in db.ΑΝΑΘΕΣΕΙΣ_ΑΝΑΚΛΗΣΗΣ_ΑΝ where d.ΑΝΑΘΕΣΗ_ΚΩΔ == sourceAnathesiId select d).FirstOrDefault();
            if (source == null) return false;
            if (source.ΑΠΟΦΑΣΗ_ΚΩΔ > 0) return false;
            ...
            if (targetAnathesiType == 1)
            {
                ΑΝΑΘΕΣΕΙΣ_ΑΚΥΡΩΤΙΚΕΣ_ΑΝ entity = new ΑΝΑΘΕΣΕΙΣ_ΑΚΥΡΩΤΙΚΕΣ_ΑΝ()
                {
                    ...
                    ΣΧΟΛΗ = source.ΣΧΟΛΗ,
                    ΣΥΜΒΑΣΗ = source.ΣΥΜΒΑΣΗ,
                    ΑΠΟΦΑΣΗ_ΕΙΔΟΣ = "ΑΚΥΡΩΤΙΚΗ-ΑΝ",
                    ΑΠΟΦΑΣΗ_ΚΩΔ = 0,
                    ΚΛΑΔΟΣ_ΚΩΔ = source.ΚΛΑΔΟΣ_ΚΩΔ,
                    ΩΡΟΜΙΣΘΙΟ_ΚΩΔ = source.ΩΡΟΜΙΣΘΙΟ_ΚΩΔ,
                    ΦΥΛΟ = source.ΦΥΛΟ
                };
                db.ΑΝΑΘΕΣΕΙΣ_ΑΚΥΡΩΤΙΚΕΣ_ΑΝ.Add(entity);
                db.SaveChanges();
            }
            else if (targetAnathesiType == 7)
            {
        ...
        public bool DeleteAnathesiRevokeAN(int sourceAnathesiId)
        {
            ΑΝΑΘΕΣΕΙΣ_ΑΝΑΚΛΗΣΗΣ_ΑΝ entity = db.ΑΝΑΘΕΣΕΙΣ_ΑΝΑΚΛΗΣΗΣ_ΑΝ.Find(sourceAnathesiId);
            if (entity != null)
            {
                db.Entry(entity).State = EntityState.Deleted;
                db.ΑΝΑΘΕΣΕΙΣ_ΑΝΑΚΛΗΣΗΣ_ΑΝ.Remove(entity);
                db.SaveChanges();
                return true;
            }
            else return false;
        ...
        public bool MoveAnathesiModifyAN(int sourceAnathesiId, int targetAnathesiType)
        {
            var source = (from d in db.ΑΝΑΘΕΣΕΙΣ_ΤΡΟΠΟΠΟΙΗΤΙΚΕΣ_ΑΝ where d.ΑΝΑΘΕΣΗ_ΚΩΔ == sourceAnathesiId select d).FirstOrDefault();
            if (source == null) return false;
            if (source.ΑΠΟΦΑΣΗ_ΚΩΔ > 0) return false;
        ...
        public bool DeleteAnathesiModifyAN(int sourceAnathesiId)
        {
            ΑΝΑΘΕΣΕΙΣ_ΤΡΟΠΟΠΟΙΗΤΙΚΕΣ_ΑΝ entity = db.ΑΝΑΘΕΣΕΙΣ_ΤΡΟΠΟΠΟΙΗΤΙΚΕΣ_ΑΝ.Find(sourceAnathesiId);
            if (entity != null)
            {
                db.Entry(entity).State = EntityState.Deleted;
                db.ΑΝΑΘΕΣΕΙΣ_ΤΡΟΠΟΠΟΙΗΤΙΚΕΣ_ΑΝ.Remove(entity);
                db.SaveChanges();
                return true;
            }
            else return false;
        ...
        public bool MoveAnathesiModifyANAK(int sourceAnathesiId, int targetAnathesiType)
        {
            var source = (from d in db.ΑΝΑΘΕΣΕΙΣ_ΤΡΟΠΟΠΟΙΗΤΙΚΕΣ_ΑΝ_ΑΚ where d.ΑΝΑΘΕΣΗ_ΚΩΔ == sourceAnathesiId select d).FirstOrDefault();
            if (source == null) return false;
            if (source.ΑΠΟΦΑΣΗ_ΚΩΔ > 0) return false;
        ...
        public bool DeleteAnathesiModifyANAK(int sourceAnathesiId)
        {
            ΑΝΑΘΕΣΕΙΣ_ΤΡΟΠΟΠΟΙΗΤΙΚΕΣ_ΑΝ_ΑΚ entity = db.ΑΝΑΘΕΣΕΙΣ_ΤΡΟΠΟΠΟΙΗΤΙΚΕΣ_ΑΝ_ΑΚ.Find(sourceAnathesiId);
            if (entity != null)
            {
                db.Entry(entity).State = EntityState.Deleted;
                db.ΑΝΑΘΕΣΕΙΣ_ΤΡΟΠΟΠΟΙΗΤΙΚΕΣ_ΑΝ_ΑΚ.Remove(entity);
                db.SaveChanges();
                return true;
            }
            else return false;
        ...
        public bool MoveAnathesiInitialAN(int sourceAnathesiId, int targetAnathesiType)
        {
            var source = (from d in db.ΑΝΑΘΕΣΕΙΣ_ΑΡΧΙΚΕΣ_ΑΝ where d.ΑΝΑΘΕΣΗ_ΚΩΔ == sourceAnathesiId select d).FirstOrDefault();
            if (source == null) return false;
            if (source.ΑΠΟΦΑΣΗ_ΚΩΔ > 0) return false;

            if (targetAnathesiType == 5)
            {
                ΑΝΑΘΕΣΕΙΣ_ΣΥΜΠΛΗΡΩΜΑΤΙΚΕΣ_ΑΝ entity = new ΑΝΑΘΕΣΕΙΣ_ΣΥΜΠΛΗΡΩΜΑΤΙΚΕΣ_ΑΝ()
                {
                    ...
                    ΣΧΟΛΗ = source.ΣΧΟΛΗ,
                    ΣΥΜΒΑΣΗ = source.ΣΥΜΒΑΣΗ,
                    ΑΠΟΦΑΣΗ_ΕΙΔΟΣ = "ΣΥΜΠΛΗΡΩΜΑΤΙΚΗ-ΑΝ",
                    ΑΠΟΦΑΣΗ_ΚΩΔ = 0,
                    ΚΛΑΔΟΣ_ΚΩΔ = source.ΚΛΑΔΟΣ_ΚΩΔ,
                    ΩΡΟΜΙΣΘΙΟ_ΚΩΔ = source.ΩΡΟΜΙΣΘΙΟ_ΚΩΔ,
                    ΦΥΛΟ = source.ΦΥΛΟ
                };
                db.ΑΝΑΘΕΣΕΙΣ_ΣΥΜΠΛΗΡΩΜΑΤΙΚΕΣ_ΑΝ.Add(entity);
                db.SaveChanges();
            }
            else return false;
        ...
        public bool DeleteAnathesiInitialAN(int sourceAnathesiId)
        {
            ΑΝΑΘΕΣΕΙΣ_ΑΡΧΙΚΕΣ_ΑΝ entity = db.ΑΝΑΘΕΣΕΙΣ_ΑΡΧΙΚΕΣ_ΑΝ.Find(sourceAnathesiId);
            if (entity != null)
            {
                db.Entry(entity).State = EntityState.Deleted;
                db.ΑΝΑΘΕΣΕΙΣ_ΑΡΧΙΚΕΣ_ΑΝ.Remove(entity);
                db.SaveChanges();
                return true;
            }
            else return false;
        ...
        public bool MoveAnathesiSupplementAN(int sourceAnathesiId, int targetAnathesiType)
        {
            var source = (from d in db.ΑΝΑΘΕΣΕΙΣ_ΣΥΜΠΛΗΡΩΜΑΤΙΚΕΣ_ΑΝ where d.ΑΝΑΘΕΣΗ_ΚΩΔ == sourceAnathesiId select d).FirstOrDefault();
            if (source == null) return false;
            if (source.ΑΠΟΦΑΣΗ_ΚΩΔ > 0) return false;
            ...
            if (targetAnathesiType == 4)
            {
                ΑΝΑΘΕΣΕΙΣ_ΑΡΧΙΚΕΣ_ΑΝ entity = new ΑΝΑΘΕΣΕΙΣ_ΑΡΧΙΚΕΣ_ΑΝ()
                {
                    ...
                    ΣΧΟΛΗ = source.ΣΧΟΛΗ,
                    ΣΥΜΒΑΣΗ = source.ΣΥΜΒΑΣΗ,
                    ΑΠΟΦΑΣΗ_ΕΙΔΟΣ = "ΑΡΧΙΚΗ-ΑΝ",
                    ΑΠΟΦΑΣΗ_ΚΩΔ = 0,
                    ΚΛΑΔΟΣ_ΚΩΔ = source.ΚΛΑΔΟΣ_ΚΩΔ,
                    ΩΡΟΜΙΣΘΙΟ_ΚΩΔ = source.ΩΡΟΜΙΣΘΙΟ_ΚΩΔ,
                    ΦΥΛΟ = source.ΦΥΛΟ
                };
                db.ΑΝΑΘΕΣΕΙΣ_ΑΡΧΙΚΕΣ_ΑΝ.Add(entity);
                db.SaveChanges();
            }
            else return false;
        ...
        public bool DeleteAnathesiSupplementAN(int sourceAnathesiId)
        {
            ΑΝΑΘΕΣΕΙΣ_ΣΥΜΠΛΗΡΩΜΑΤΙΚΕΣ_ΑΝ entity = db.ΑΝΑΘΕΣΕΙΣ_ΣΥΜΠΛΗΡΩΜΑΤΙΚΕΣ_ΑΝ.Find(sourceAnathesiId);
            if (entity != null)
            {
                db.Entry(entity).State = EntityState.Deleted;
                db.ΑΝΑΘΕΣΕΙΣ_ΣΥΜΠΛΗΡΩΜΑΤΙΚΕΣ_ΑΝ.Remove(entity);
                db.SaveChanges();
                return true;
            }
            else return false;
        ...
        public ActionResult RegAnatheseisProslipsi(string notify = null)
        {
            bool val1 = (System.Web.HttpContext.Current.User != null) && System.Web.HttpContext.Current.User.Identity.IsAuthenticated;
            if (!val1)
            {
            ...
            var data = regAnathesiProslipsiService.ReadEpas();
            if (data.Count() == 0)
            {
        ...
        {
            var data = regAnathesiProslipsiService.ReadEpas(schoolyearId);
        ...
        public PartialViewResult GetAnathesiProslipsiRecord(int recordId)
        {
            ...
            return PartialView("RegAnathesiProslipsiPartial", data);
        }
        ...
        public ActionResult RegAnatheseisProslipsiAn(string notify = null)
        {
            bool val1 = (System.Web.HttpContext.Current.User != null) && System.Web.HttpContext.Current.User.Identity.IsAuthenticated;
            if (!val1)
            {
        ...
        public PartialViewResult GetAnathesiProslipsiAnRecord(int recordId)
        {
            ...
            return PartialView("RegAnathesiProslipsiAnPartial", data);
        }
        ...
        public ActionResult RegAnatheseisMetaboli(string notify = null)
        {
            bool val1 = (System.Web.HttpContext.Current.User != null) && System.Web.HttpContext.Current.User.Identity.IsAuthenticated;
            if (!val1)
            {
            ...
            var data = regAnathesiMetaboliService.ReadEpas();
            if (data.Count() == 0)
            {
                string msg = "Δεν υπάρχουν καταχωρημένες αναθέσεις για την εμφάνιση του μητρώου.";
                return RedirectToAction("Index", "Admin", new { notify = msg });
        ...
        {
            var data = regAnathesiMetaboliService.ReadEpas(schoolyearId);
        ...
        public PartialViewResult GetAnathesiMetaboliRecord(int recordId)
        {
            ...
            return PartialView("RegAnathesiMetaboliPartial", data);
        }
        ...
        public ActionResult RegAnatheseisMetaboliAn(string notify = null)
        {
            bool val1 = (System.Web.HttpContext.Current.User != null) && System.Web.HttpContext.Current.User.Identity.IsAuthenticated;
            if (!val1)
            {
        ...
        public PartialViewResult GetAnathesiMetaboliAnRecord(int recordId)
        {
            ...
            return PartialView("RegAnathesiMetaboliAnPartial", data);
        }
        ...
        public ActionResult AnatheseisUniversal(string notify = null)
        {
            bool val1 = (System.Web.HttpContext.Current.User != null) && System.Web.HttpContext.Current.User.Identity.IsAuthenticated;
            if (!val1)
            {
        ...
        public PartialViewResult GetAnathesiUniversalRecord(int recordId)
        {
            ...
            return PartialView("AnatheseisUniversalPartial", data);
        }
        ...
        public ActionResult AnatheseisUniversal2(string notify = null)
        {
            bool val1 = (System.Web.HttpContext.Current.User != null) && System.Web.HttpContext.Current.User.Identity.IsAuthenticated;
            if (!val1)
            {
        ...
        public PartialViewResult GetAnathesiUniversal2Record(int recordId)
        {
            ...
            return PartialView("AnatheseisUniversal2Partial", data);
        }
        ...
        public ActionResult regAnatheseisProslipsiPrint()
        {
            bool val1 = (System.Web.HttpContext.Current.User != null) && System.Web.HttpContext.Current.User.Identity.IsAuthenticated;
            if (!val1)
            {
        ...
        public ActionResult regAnatheseisMetabolesPrint()
        {
            bool val1 = (System.Web.HttpContext.Current.User != null) && System.Web.HttpContext.Current.User.Identity.IsAuthenticated;
            if (!val1)
            {
        ...
        public ActionResult regAnatheseisProslipsiAnaplPrint()
        {
            bool val1 = (System.Web.HttpContext.Current.User != null) && System.Web.HttpContext.Current.User.Identity.IsAuthenticated;
            if (!val1)
            {
        ...
        public ActionResult regAnatheseisMetabolesAnaplPrint()
        {
            bool val1 = (System.Web.HttpContext.Current.User != null) && System.Web.HttpContext.Current.User.Identity.IsAuthenticated;
            if (!val1)
            {
        ...
        public ActionResult ReportSelectorDetail(int reportId = 0)
        {
            ...
            if (reportId == 1)
            {
                return RedirectToAction("AnatheseisAnaEidikotitaPrint", "Admin");
            }
            else if (reportId == 2)
            {
                return RedirectToAction("AnatheseisAno20HoursPrint", "Admin");
            }
            else if (reportId == 3)
            {
                return RedirectToAction("AnatheseisPollaplesPrint", "Admin");
            }
            else if (reportId == 4)
            {
                return RedirectToAction("AnatheseisDetailsPrint", "Admin");
            }
            else if (reportId == 5)
            {
                return RedirectToAction("AnatheseisDetailSummaryPrint", "Admin");
            }
            else if (reportId == 6)
            {
                return RedirectToAction("AnatheseisDetailsList1Print", "Admin");
            }
            else if (reportId == 7)
            {
                return RedirectToAction("AnatheseisDetailsList2Print", "Admin");
            }
            else if (reportId == 8)
            {
                return RedirectToAction("AnatheseisCancelListPrint", "Admin");
            }
            else if (reportId == 17)
            {
                return RedirectToAction("AnatheseisPrimaryEidikotitaPrint", "Admin");
            }
            else if (reportId == 23)
            {
                return RedirectToAction("AnatheseisDetailsList3Print", "Admin");
            }
            else if (reportId == 24)
            {
                return RedirectToAction("AnatheseisDetailsList4Print", "Admin");
            }
            else if (reportId == 27)
            {
                return RedirectToAction("BudgetAnatheseisDatesPrint", "Admin");
            }
            else if (reportId == 28)
            {
                return RedirectToAction("AnatheseisHourLimitsPrint", "Admin");
            }
            else
            {
        ...
        public ActionResult ReportSelectorSummary(int reportId = 0)
        {
            ...
            if (reportId == 9)
            {
                return RedirectToAction("smTeachersKladosHoursPrint", "Admin");
            }
            else if (reportId == 10)
            {
                return RedirectToAction("smAnatheseisKladosSchoolPrint", "Admin");
            }
            else if (reportId == 11)
            {
                return RedirectToAction("smSimbasiKladosHoursPrint", "Admin");
            }
            else if (reportId == 12)
            {
                return RedirectToAction("smAnatheseisKladosPeriferiaPrint", "Admin");
            }
            else if (reportId == 13)
            {
                return RedirectToAction("smAnatheseisKladosGenderPrint", "Admin");
            }
            else if (reportId == 14)
            {
                return RedirectToAction("smAnatheseisKladosDomiPrint", "Admin");
            }
            else if (reportId == 15)
            {
                return RedirectToAction("smAnatheseisHoursDomiPrint", "Admin");
            }
            else if (reportId == 16)
            {
                return RedirectToAction("smTeachersMonesPollaplesPrint", "Admin");
            }
            else if (reportId == 18)
            {
                return RedirectToAction("smAnatheseisEidikotitaPrint", "Admin");
            }
            else if (reportId == 19)
            {
                return RedirectToAction("statOpekaTeacherSummaryPrint", "Admin");
            }
            else if (reportId == 20)
            {
                return RedirectToAction("hrEidikotitesManpowerPrint", "Admin");
            }
            else if (reportId == 21)
            {
                return RedirectToAction("hrEidikotitesUnifiedSchoolPrint", "Admin");
            }
            else if (reportId == 22)
            {
                return RedirectToAction("hrEidikotitesUnifiedPeriferiaPrint", "Admin");
            }
            else if (reportId == 25)
            {
                return RedirectToAction("sysApofaseisPersonPrint", "Admin");
            }
            else if (reportId == 26)
            {
                return RedirectToAction("sysApofaseisTypesPrint", "Admin");
            }
            else if (reportId == 29)
            {
                return RedirectToAction("smEidikotitesPeriferiaPrint", "Admin");
            }
            else if (reportId == 30)
            {
                return RedirectToAction("smEidikotitesManpowerPrint", "Admin");
            }
            else if (reportId == 31)
            {
                return RedirectToAction("statTeachersPeriferiaSchoolPrint", "Admin");
            }
            else if (reportId == 34)
            {
                return RedirectToAction("TeachersEidikotitaCountPrint", "Admin");
            }
            else
            {
                return RedirectToAction("ReportDemoPrint", "Admin");
