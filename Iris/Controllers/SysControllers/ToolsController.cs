...
namespace Iris.Controllers.SysControllers
{
    ...
    public class ToolsController : Controller
    {
        ...
        private readonly IDiaxiristesService diaxiristesService;
        ...
        public ToolsController(IrisDBEntities entities, ISchoolService schoolService,
            ...
            IDiaxiristesService diaxiristesService, IProistamenoiService proistamenoiService,
            IDirectorsService directorsService, IGenikoiService genikoiService,
            IAntiproedroiService antiproedroiService, IDioikitesService dioikitesService)
        {
            db = entities;
            ...
            this.diaxiristesService = diaxiristesService;
        ...
        {
            var data = schoolService.Read("D1");
        ...
        public ActionResult SchoolEdit(int schoolId)
        {
            bool val1 = (System.Web.HttpContext.Current.User != null) && System.Web.HttpContext.Current.User.Identity.IsAuthenticated;
            if (!val1)
            {
        ...
        [HttpPost]
        public ActionResult SchoolEdit(int schoolId, SchoolsViewModel data)
        {
            bool val1 = (System.Web.HttpContext.Current.User != null) && System.Web.HttpContext.Current.User.Identity.IsAuthenticated;
            if (!val1)
            {
        ...
        public ActionResult SchoolDataPrint()
        {
            bool val1 = (System.Web.HttpContext.Current.User != null) && System.Web.HttpContext.Current.User.Identity.IsAuthenticated;
            if (!val1)
            {
        ...
        public ActionResult SchoolData2Print()
        {
            bool val1 = (System.Web.HttpContext.Current.User != null) && System.Web.HttpContext.Current.User.Identity.IsAuthenticated;
            if (!val1)
            {
        ...
        public ActionResult ProkirixiApofaseis()
        {
            bool val1 = (System.Web.HttpContext.Current.User != null) && System.Web.HttpContext.Current.User.Identity.IsAuthenticated;
            if (!val1)
            {
        ...
        public ActionResult ProkirixiApofaseisEdit(int recordID)
        {
            bool val1 = (System.Web.HttpContext.Current.User != null) && System.Web.HttpContext.Current.User.Identity.IsAuthenticated;
            if (!val1)
            {
        ...
        [HttpPost]
        public ActionResult ProkirixiApofaseisEdit(int recordID, SysProkirixiApofasiViewModel data)
        {
            bool val1 = (System.Web.HttpContext.Current.User != null) && System.Web.HttpContext.Current.User.Identity.IsAuthenticated;
            if (!val1)
            {
        ...
        public ActionResult ApofasiParameters()
        {
            bool val1 = (System.Web.HttpContext.Current.User != null) && System.Web.HttpContext.Current.User.Identity.IsAuthenticated;
            if (!val1)
            {
        ...
        public ActionResult ApofasiParametersEdit(int recordId)
        {
            bool val1 = (System.Web.HttpContext.Current.User != null) && System.Web.HttpContext.Current.User.Identity.IsAuthenticated;
            if (!val1)
            {
        ...
        [HttpPost]
        public ActionResult ApofasiParametersEdit(int recordId, SysApofasiParametersViewModel data)
        {
            bool val1 = (System.Web.HttpContext.Current.User != null) && System.Web.HttpContext.Current.User.Identity.IsAuthenticated;
            if (!val1)
            {
        ...
        public ActionResult EpitropesApofaseis()
        {
            bool val1 = (System.Web.HttpContext.Current.User != null) && System.Web.HttpContext.Current.User.Identity.IsAuthenticated;
            if (!val1)
            {
        ...
        public ActionResult EidikotitesKladoi()
        {
            bool val1 = (System.Web.HttpContext.Current.User != null) && System.Web.HttpContext.Current.User.Identity.IsAuthenticated;
            if (!val1)
            {
        ...
        public ActionResult KladoiHours()
        {
            bool val1 = (System.Web.HttpContext.Current.User != null) && System.Web.HttpContext.Current.User.Identity.IsAuthenticated;
            if (!val1)
            {
        ...
        public ActionResult CreatePasswords()
        {
            ...
            return RedirectToAction("UserSchools", "Tools", new { notify });
        }
